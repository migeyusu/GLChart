...
namespace GLChart.OpenTK.Renderer
{
    ...
    public class Shader
    {
        private readonly string _vertexShaderSource, _fragmentShaderSource;
        ...
        public Shader(string vertPath, string fragPath)
        {
            ...
            _vertexShaderSource = File.ReadAllText(vertPath);
            // We do the same for the fragment shader
            fragPath = Path.GetFullPath(fragPath);
            _fragmentShaderSource = File.ReadAllText(fragPath);
        }
